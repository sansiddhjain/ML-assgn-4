...
x = model.fit(X_train, y_train_one_hot, epochs=25, batch_size=100, verbose=2, validation_data=(X_val, y_val_one_hot))
...
df_sub.to_csv('kurapan2.csv', index=False)

filename = 'kurapan2.pkl'
model.save('kurapan2.h5')
