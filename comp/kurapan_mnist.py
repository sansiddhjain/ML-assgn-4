...
x = model.fit(X_train, y_train_one_hot, epochs=30, batch_size=100, verbose=2, validation_data=(X_val, y_val_one_hot))
...
df_sub.to_csv('kurapan_mnist.csv', index=False)

filename = 'kurapan_mnist.pkl'
model.save('kurapan_mnist.h5')
