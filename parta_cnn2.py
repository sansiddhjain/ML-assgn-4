...
x = model.fit(X_train, y_train_one_hot, epochs=20, batch_size=128, verbose=2, validation_data=(X_val, y_val_one_hot))
print x
...
df_sub.to_csv('comp/submission_cnn_mnist_half.csv', index=False)
